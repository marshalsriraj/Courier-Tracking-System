...
um_isActive bit,
--as 'CTS200000' + convert(varchar, um_id),
um_Salary bigint,
...
alter table [Cts_User_Master]
drop column um_emp_id

insert into [Cts_User_Master]
(um_userId,um_password,um_firstName,um_lastName,um_gender,um_contact,um_emailId,um_isActive,um_emp_id,um_Salary,um_Designation,um_PerAddress,um_CorAddress,um_created_On,um_created_by,um_IsApprovedOn,um_IsApprovedBy,um_RoleId)
values
('superadmin','123456','Super','Administrator','Male','9848012345','superadmin@gmail.com',1,11111, 500000, 'CEO','Chennai','Chennai',getdate(),'System',getdate(),'System',1),
('admin','123456','Administrator','Sample','Male','9849012345','admin@gmail.com',1,22222, 400000, 'Manager','Chennai','Chennai',getdate(),'System',getdate(),'System',2),
('staff','123456','Staff','Sample','Male','9899012345','agent@gmail.com',1,33333, 300000, 'Employee','Chennai','Chennai',getdate(),'System',getdate(),'System',3),
